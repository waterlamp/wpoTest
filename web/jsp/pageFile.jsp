...
<div class="row">
	<div class="col-3" style="text-align:center" >
        记录数：${page.totalRecords}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第${page.currentPageNum}页/共${page.totalPageNum}页
    </div>
	<div class="col-6">
		<nav aria-label="...">
				...
				<c:forEach begin="${page.startPage}" end="${page.endPage}" var="pagenum">
					<c:if test="${page.currentPageNum==pagenum}">
						<li class='page-item active' id="currentPage">
							<a class='page-link' href="${pageContext.request.contextPath}/${page.url}&num=${pagenum}">
									${pagenum}
							</a>
						</li>
					</c:if>
	...
	<div class="col-3 mb-3 input-group">
		<input type="text" class="form-control" id="pagenum" name="pagenum" size="1"/>
		<input type="button" class="btn btn-outline-secondary" value="前往" onclick="jump()" />
	</div>
